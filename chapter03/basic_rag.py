...
def get_user_info() -> str:
    # user = requests.get('https://api.example.com/member/)

    user = User(
        name="John",
        email="john@example.com",
        memo="polite person",
        last_inquiry="I gave a problem, your service is aweful",
    )
...
def get_customer_center_guide() -> str:
    ...
    - inquiry the cooker is abailabe

    """


# ASSISTANT_PERSONA = "you are a helpful assistant, your job is to answer user's inquiry"
STAFF_PERSONA = "you are a Customer Center staff, your job is to answer customer's inquiry following the Customer's info and the guide"
